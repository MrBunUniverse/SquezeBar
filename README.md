...
- **Windows (Beta)**: Download [`SqueezeBar-v0.98-beta.exe`](https://github.com/MrBunUniverse/SquezeBar/releases/latest) -> Double-click to run *(Portable, no installation required)*.
